...
<div class="container">
    <div class="content">
        ...
        <ul>
            <li>It is acceptably legal to hack your console.</li>
            <li>It is acceptably legal to make a backup of a piece of software that you legally purchased and have full ownership of.</li>
            ...
            <li>Think of a dumped game like an extension of the cartridge. If you lose, damage, lend or sell the cartridge, you can't access the dump. (This also means you can't use the dump and the cart on 2 systems you own at the same time.)</li>
