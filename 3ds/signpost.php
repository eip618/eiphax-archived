...
require('header.php')
?>
<!-- todo: fix the constant opening of <p> blocks but the lack of closing them -->
<div class="container">
    <div class="content">
        ...
        <div class="box hidden" id="learn">
            ...
            <div class="box hidden" id="L1" style="margin-left: 60px">
                <p>try <a href="./what.php">this</a> for a moderately in depth explanation of hacking and the 3ds hardware and software<br>also try <a href="http://3dbrew.org">3dbrew</a> for more depth
            </div>
            ...
            <div class="box hidden" id="L2" style="margin-left: 60px">
                <p>try joining the nintendo homebrew discord: <a href="https://discord.gg/C29hYvh">here</a> and ask in the #hacking-general or #dev channels
            </div>
        ...
        <div class="box hidden" id="do">
            ...
            <div class="box hidden" id="D2" style="margin-left: 60px">
                    <p>get custom firmware (try <a href="https://3ds.hacks.guide/seedminer" target="_blank">seedminer</a>), make sure you follow finalising setup, then check <a href="./pkhex.php">here</a> to learn to dump your save, edit your save, then reinject it
            </div>
            <p>
            ...
            <div class="box hidden" id="D3" style="margin-left: 60px">
                    <p>get custom firmware (try <a href="https://3ds.hacks.guide/seedminer" target="_blank">seedminer</a>), make sure you follow finalising setup, then check <a href="./acnl.php">here</a> to learn to dump your save, edit your save, then reinject it
            </div>
            <p>         
            ...
            <div class="box hidden" id="D6" style="margin-left: 60px">
                <p>here's a guide on <a href="twlmenu.php" target="_blank">TWiLightMenu++</a>.
            </div>
            <p>
		  ...
		  <!-- these two ending divs are opened at the top of body as container and content -->
    </div>
</div>
