...
<div class="container">
	<div class="content">
		...
		<br><b>All of these methods install TWiLightMenu++. You only need to use another method if the previous one DOES NOT WORK.</b>
		<p>
		...
		<div class="box hidden" id="easier">
			...
			<ol>
				...
				<img src="https://tinydb.eiphax.tech/qr/258/16811351/QR.png"></li>
				<li>Install the CIA it links to.</li>
				<li>The updater should appear on your home screen. If it does not, reboot your console.</li>
				<li>Open the updater.</li>
				<li>Select "release" next to TWLMenu++. This may take quite a while.</li>
				<li>Select "release" next to nds-bootstrap. This may take quite a while.</li>
				<li>Exit the updater.</li>
				<li>TWiLightMenu++ should be on your home screen. If it is not, reboot the console.</li>
			</ol>
			<p>Got problems? Something didn't work? Try the Easy Way below.
		</div>
		...
		<div class="box hidden" id="easy">
			...
			<ol>
				...
				<li>In your SD card root directory, make a folder called "roms" if one does not already exist.</li>
				<li>Put the TWiLightMenu++ Updater .cia into the "cias" folder.</li>
				<li>Put any .nds roms you wish to play into the "roms" folder. Games can be added at any time.</li>
				<li>Safely eject your SD card and put it back into your console.</li>
				<li>Boot your console and launch FBI.</li>
				<li>Go to SD > cias</li>
				<li>Select the TWiLightMenu++ Updater cia and select "install and delete"</li>
				<li>Once this succeeds, exit FBI.</li>
				<li>The updater should appear on your home screen. If it does not, reboot your console.</li>
				<li>Open the updater.</li>
				<li>Select "release" next to TWLMenu++. This may take quite a while.</li>
				<li>Select "release" next to nds-bootstrap. This may take quite a while.</li>
		...
		<div class="box hidden" id="manual">
			...
			<ol>
				...
				<li>In your SD card root directory, make a folder called "cias" if one does not already exist.</li>
				<li>In your SD card root directory, make a folder called "roms" if one does not already exist.</li>
				<li>Extract the TWiLightMenu++ .7z folder to a location of your choice.</li>
				<li>From that folder, put the "_nds" folder in your SD card root directory.</li>
				<li>From that folder, open "DSi&3DS - SD card users". Put the "_nds" folder and "boot.nds" into your SD card root directory. <b>The new folder should be merged with the existing folder. If this confuses you, ask for help.</b></li>
				<li>From the original folder, open "3DS - CFW users" > "cia". Put the 2 cias (menu and game booter) into the "cias" folder on your SD card.</li>
				<li>Put any NDS roms you wish to use into the "roms" folder.</li>
				<li>Put your SD card back in your console.</li>
				<li>Hold SELECT, and power on your console while continuing to hold SELECT.</li>
				<li>In the Luma Configuration menu that appears, scroll to "Enable game patching".</li>
				<li>Press A to place a check in this box. If there is already a check in this box, do not remove it. Press START to save your settings and continue.</li>
				<li>Once at your home screen, open FBI.</li>
				<li>Open the "SD" menu, then open the "cias" folder.</li>
				<li>Select "&lt;current directory&gt;", then select "Install and delete all CIAs".</li>
				<li>Once this operation has finished, restart your console.</li>
