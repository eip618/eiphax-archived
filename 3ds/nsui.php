...
<div class="container">
    <div class="content">
        ...
        <hr>
        The <a href="https://mega.nz/#!qnAE1YjC!q3FRHgIAVEo4nRI2IfANHJr-r7Sil3YpPYE4w8ZbUPY" target=”_blank”>New Super Ultimate Injector</a> can be used to create installable games from certain older consoles on a 3DS Family system. <br>The 3DS natively contains hardware to run such games, which is why VC Injects (which is what these are) are more desirable than emulators, as they automatically get better performance and compatibility. 
        <div class="warning"><b>If you wish to run Nintendo DS (ie "old DS") games, you should use <a href="twlmenu.html" target=”_blank”>TWiLightMenu++</a> instead.</b></div>
        <hr>
